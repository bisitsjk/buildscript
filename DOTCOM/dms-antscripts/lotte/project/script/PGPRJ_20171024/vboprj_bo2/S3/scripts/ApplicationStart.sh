...
tar -xf bo2_PGPRJ_20171024_PROJECT_WEB.tar

sleep 5

tar -xf bo2_PGPRJ_20171024_PROJECT_WAS.tar
...
rm -fr /h2010/bo2/bo2_PGPRJ_20171024_PROJECT_WEB.tar
rm -fr /h2010/bo2/bo2_PGPRJ_20171024_PROJECT_WAS.tar
