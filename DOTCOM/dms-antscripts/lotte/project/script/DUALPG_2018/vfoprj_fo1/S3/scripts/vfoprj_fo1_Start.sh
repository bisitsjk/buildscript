...
tar -xf fo_DUALPG_2018_PROJECT_WEB.tar

sleep 5

tar -xf fo_DUALPG_2018_PROJECT_WAS.tar
...
rm -fr /h2010/fo/fo_DUALPG_2018_PROJECT_WEB.tar
rm -fr /h2010/fo/fo_DUALPG_2018_PROJECT_WAS.tar
