...
tar -xf fo_LPayWeb_20170622_PROJECT_WEB.tar

sleep 5

tar -xf fo_LPayWeb_20170622_PROJECT_WAS.tar
...
rm -fr /h2010/fo/fo_LPayWeb_20170622_PROJECT_WEB.tar
rm -fr /h2010/fo/fo_LPayWeb_20170622_PROJECT_WAS.tar
