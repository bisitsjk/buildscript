...
tar -xf mo_NewEllottePrj_201808_PROJECT_WEB.tar

sleep 5

tar -xf mo_NewEllottePrj_201808_PROJECT_WAS.tar
...
rm -fr /h2010/mo/mo_NewEllottePrj_201808_PROJECT_WEB.tar
rm -fr /h2010/mo/mo_NewEllottePrj_201808_PROJECT_WAS.tar
