...
tar -xf fo_EllotteAI_20171020_PROJECT_WEB.tar

sleep 5

tar -xf fo_EllotteAI_20171020_PROJECT_WAS.tar
...
rm -fr /h2010/fo/fo_EllotteAI_20171020_PROJECT_WEB.tar
rm -fr /h2010/fo/fo_EllotteAI_20171020_PROJECT_WAS.tar
