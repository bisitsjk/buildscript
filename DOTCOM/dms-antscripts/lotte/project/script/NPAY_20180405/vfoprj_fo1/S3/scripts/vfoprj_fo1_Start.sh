...
tar -xf fo_NPAY_20180405_PROJECT_WEB.tar

sleep 5

tar -xf fo_NPAY_20180405_PROJECT_WAS.tar
...
rm -fr /h2010/fo/fo_NPAY_20180405_PROJECT_WEB.tar
rm -fr /h2010/fo/fo_NPAY_20180405_PROJECT_WAS.tar
