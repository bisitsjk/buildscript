...
tar -xf bo_NPAY_20180405_PROJECT_WEB.tar

sleep 5

tar -xf bo_NPAY_20180405_PROJECT_WAS.tar
...
rm -fr /h2010/bo/bo_NPAY_20180405_PROJECT_WEB.tar
rm -fr /h2010/bo/bo_NPAY_20180405_PROJECT_WAS.tar
