...
aws elbv2 register-targets --target-group-arn $BOWEB_T_ARN --targets Id=$BO2_EC2_ID --region $awsDefaultRegion

sleep 1

aws elbv2 register-targets --target-group-arn $CCWEB_T_ARN --targets Id=$CC2_EC2_ID --region $awsDefaultRegion

sleep 1

aws elbv2 register-targets --target-group-arn $POWEB_T_ARN --targets Id=$PO2_EC2_ID --region $awsDefaultRegion
