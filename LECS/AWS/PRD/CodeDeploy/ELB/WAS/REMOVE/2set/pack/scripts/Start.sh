...
aws elb deregister-instances-from-load-balancer --load-balancer-name $BOWAS_ELB_NAME --instances $BO2_EC2_ID --region $awsDefaultRegion
...
aws elb deregister-instances-from-load-balancer --load-balancer-name $CCWAS_ELB_NAME --instances $CC2_EC2_ID --region $awsDefaultRegion
...
aws elb deregister-instances-from-load-balancer --load-balancer-name $POWAS_ELB_NAME --instances $PO2_EC2_ID --region $awsDefaultRegion
