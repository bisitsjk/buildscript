...
v_mujikorea     DOCROOT="/lotte/lecsDocs/contents/lps",
                ...
                HOSTALIAS = "121.254.239.24, lecs.nikestore.co.kr, ws.lecs.com", 
                PORT = "80",
...
*SVRGROUP
htmlg               NODENAME = "lpsweb2", SVRTYPE = HTML
mujikoreag          NODENAME = "lpsweb2", SVRTYPE = JSV, VhostName = v_mujikorea
mujikoreasslg       NODENAME = "lpsweb2", SVRTYPE = JSV, VhostName = v_mujikorea_ssl
