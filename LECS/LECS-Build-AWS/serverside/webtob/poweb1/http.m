...
v_lecs_ssl      DOCROOT="/lotte/lecsDocs/contents/bo",
                NODENAME = poweb1,
                HOSTNAME = "www.lecs.com",
                HOSTALIAS = "121.254.239.34, muji.lecs.com, nike.lecs.com",
                PORT = "443",
...
*SSL
lecsssl        CertificateFile = "/usr2/webtob/ssl/loserver.crt",
               CertificateKeyFile = "/usr2/webtob/ssl/loserver.key"

*SVRGROUP
htmlg          NODENAME = "poweb1", SVRTYPE = HTML
lecssslg       NODENAME = "poweb1", SVRTYPE = JSV, VhostName = v_lecs_ssl
