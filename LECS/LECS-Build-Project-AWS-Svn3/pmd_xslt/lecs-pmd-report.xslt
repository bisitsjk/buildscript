	...
	<xsl:template match="pmd">
		<html>
			...
			<body>
				<H1>
					<div class="top">
						<div class="left">LECS PMD Report</div>
						<div class="right">
						...
						<xsl:for-each select="violation">
							<tr>
								...
								<td style="padding: 3px" align="right">
									<xsl:value-of disable-output-escaping="yes" select="@rule" />
								</td>
								<td style="padding: 3px" align="right">
									<xsl:value-of disable-output-escaping="yes" select="@ruleset" />
								</td>
								<td style="padding: 3px" align="right">
									<div>
										<xsl:attribute name="class"><xsl:call-template name="priorityDiv" /></xsl:attribute>
