...
v_lecs_ssl      DOCROOT="/lotte/lecsDocs/contents/bo",
                NODENAME = ccweb1,
                HOSTNAME = "cc.lecs.com",
                HOSTALIAS = "121.254.239.30",
                PORT = "443",
...
*SSL
lecsssl         CertificateFile = "/usr2/webtob/ssl/secure_cc_lecs.pem",
                CertificateKeyFile = "/usr2/webtob/ssl/secure_cc_lecs.pem",
                CACertificateFile = "/usr2/webtob/ssl/secureCA.pem",
                CACertificatePATH = "/usr2/webtob/ssl/",
                PassPhraseDialog = "exec:     /usr2/webtob/ssl/.SSL_KEY_PASSWORD_CC_LECS",
...
*SVRGROUP
htmlg          NODENAME = "ccweb1", SVRTYPE = HTML
lecssslg       NODENAME = "ccweb1", SVRTYPE = JSV, VhostName = v_lecs_ssl
